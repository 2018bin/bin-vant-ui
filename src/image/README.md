...
import { Image as BinImage } from 'bin-vant-ui';
...
```js
import { createApp } from 'vue';
import { Lazyload } from 'bin-vant-ui';
...
```html
<bin-image src="https://img01.yzcdn.cn/vant/cat.jpeg">
...
```html
<!-- 错误写法 -->
<bin-image src="./image.png" />

<!-- 正确写法 -->
<bin-image :src="require('./image.png')" />
```
...
这是因为 \<image> 标签是原生的 SVG 标签，Vue 不允许将原生标签名注册为组件名，使用 \<bin-image> 即可规避这个问题。
